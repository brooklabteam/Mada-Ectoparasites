...
cap <- read.csv(paste0(homewd,"/data/Angelo_catch_dat_bart_age_2_13_2021.csv"), header = T, stringsAsFactors = F)
...
cowplot::plot_grid(E2,
          ...
          E6,
          E5,
          ncol=2, nrow = 3, labels=c("A","B","C","D","E","F"), label_size = 22, label_x = c(.1,.1))
...
#eidolon M
ggsave(filename =  paste0(homewd,"/final-figures/FigS2_1.png"),
        plot = p2,
       units="mm",  
       width=120, 
       height=90, 
...
#Eidolon F
ggsave(file =  paste0(homewd,"/final-figures/FigS2_2.png"),
       plot = p1,
       units="mm",  
       width=120, 
       height=90, 
...
#rousettus female
ggsave(file =   paste0(homewd,"/final-figures/FigS2_3.png"),
       plot = p3,
       units="mm",  
       width=120, 
       height=90, 
...
ggsave(file =   paste0(homewd,"/final-figures/FigS2_4.png"),
       plot = p4,
       units="mm",  
       width=120, 
       height=90, 
...
p4
#rousettus male - megla

ggsave(file =   paste0(homewd,"/final-figures/FigS2_5.png"),
       plot = p4,
       units="mm",  
       width=120, 
       height=90, 
...
#female megla rousettus
ggsave(file =   paste0(homewd,"/final-figures/FigS2_6.png"),
       plot = p5,
       units="mm",  
       width=120, 
       height=90, 
